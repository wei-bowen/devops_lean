...
- [03、基本构件Pod的使用](./06-container/kubernetes/03、基本构件Pod的使用.md)
...
- [11、K8s原理](./06-container/kubernetes/11、K8s原理.md)
- [12、k8s权限控制](./06-container/kubernetes/12、k8s权限控制.md)
- [13、Pod资源使用控制](./06-container/kubernetes/13、Pod资源使用控制.md)
- [14、Pod和集群节点的自动伸缩](./06-container/kubernetes/14、Pod和集群节点的自动伸缩.md)
- [15、限定Pod调度位置](./06-container/kubernetes/15、限定Pod调度位置.md)
### [7、网络](./07-network)
### [8、性能调优](./08-tuning)
